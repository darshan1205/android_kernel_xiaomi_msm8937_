...
DEFCONFIG="lineageos_rolex_defconfig"
KERNEL="Image.gz-dtb"

# Hyper Kernel Details
BASE_VER="DSM-KERNEL-NOUGAT"
VER="-$(date +"%Y-%m-%d"-%H%M)"
K_VER="$BASE_VER$VER-rolex"
...
# Paths
KERNEL_DIR=`pwd`
RESOURCE_DIR="/home/darshan1205/android/kernel/s"
ANYKERNEL_DIR="$RESOURCE_DIR/hyper"
TOOLCHAIN_DIR="/home/darshan1205/android/toolchain/aosp4.9"
